    ...
    <div class="container mx-auto px-4 py-8 relative z-10">
                ...
                @foreach ($pendingCheckOuts as $booking)
                    <div class="bg-[#383537] rounded-2xl shadow-xl p-6 border-t-[3px]"
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-5">
                            <div>
                                <p class="text-[10px] uppercase font-bold tracking-widest text-[#A0717F] mb-1">Departure Date</p>
                                <p class="text-sm font-semibold text-[#EAD3CD]">
                                    {{ $booking->check_out_date->format('M d, Y') }}
                                </p>
                            </div>
                            <div>
                                <p class="text-[10px] uppercase font-bold tracking-widest text-[#A0717F] mb-1">Occupied Suites</p>
                        ...
                        <div class="flex justify-between items-center pt-5 border-t border-[rgba(234,211,205,0.05)]">
                            ...
                            <a href="{{ route('receptionist.check-out.show', $booking) }}"
                                ...
                                style="background-color: transparent; border: 1px solid #A0717F; color: #EAD3CD;"
                                onmouseover="this.style.backgroundColor='#A0717F'; this.style.color='#FFFFFF';"
                                onmouseout="this.style.backgroundColor='transparent'; this.style.color='#EAD3CD';">
                                Process Exit
                            </a>
                        </div>
                    </div>
                    ...
                    <table class="w-full text-left whitespace-nowrap">
                        <thead style="background-color: #2E2530; border-bottom: 1px solid rgba(160, 113, 127, 0.2);">
                            <tr>
                                ...
                                <th class="px-6 py-5 text-[11px] font-bold uppercase tracking-widest" style="color: #A0717F;">Departure Date</th>
                                <th class="px-6 py-5 text-[11px] font-bold uppercase tracking-widest" style="color: #A0717F;">Occupied Suites</th>
        ...
        @else
            <div class="rounded-2xl shadow-xl p-12 text-center" style="background-color: #383537; border-top: 1px solid rgba(234, 211, 205, 0.1);">
                <x-icon name="arrow-right" class="w-12 h-12 mx-auto mb-4" style="color: rgba(160, 113, 127, 0.4);" />
